...
func TestBoolfunc1(t *testing.T) {
	...
	assert.NotEqual(t, true, boolfunc1(3))
}
...
func TestBoolfunc2(t *testing.T) {
	...
	assert.Equal(t, true, boolfunc2(false, true))
	assert.NotEqual(t, true, boolfunc2(false, false))
}
...
func TestBoollfunc4(t *testing.T) {
	...
	assert.NotEqual(t, true, boollfunc4(1, 0, 0))
	assert.NotEqual(t, true, boollfunc4(0, 1, 0))
}
...
func TestFrombooltostrlfunc(t *testing.T) {
	...
	assert.NotEqual(t, "true", frombooltostrlfunc(1, 0, 0))
	assert.NotEqual(t, "true", frombooltostrlfunc(0, 1, 0))
}

func TestComparefunc1(t *testing.T) {
	assert.NotEqual(t, true, comparefunc1(-5))
...
func TestComparefunc4(t *testing.T) {
	...
	assert.NotEqual(t, "The second gear", comparefunc4(10, 2000))
	assert.Equal(t, "The second gear", comparefunc4(25, 2000))
	assert.NotEqual(t, "The third gear", comparefunc4(25, 2000))
	assert.Equal(t, "The third gear", comparefunc4(40, 2000))
	assert.NotEqual(t, "The fourth gear", comparefunc4(40, 2000))
...
func TestSignalStrenght(t *testing.T) {
	...
	assert.NotEqual(t, 600, signalStrenght(88))
}

func TestDownloadTime(t *testing.T) {
	assert.Equal(t, 80.0, downloadTime(1, 100))
	assert.NotEqual(t, 80, downloadTime(1, 100))
}
